...
function! ag#Ag(cmd, args)
  ...
  if l:apply_mappings
    ...
    exec "nnoremap <silent> <buffer> <C-t> <C-W><CR><C-W>T"
    exec "nnoremap <silent> <buffer> T <C-W><CR><C-W>TgT<C-W><C-W>"
    exec "nnoremap <silent> <buffer> o <CR>"
    exec "nnoremap <silent> <buffer> p <CR><C-W><C-W>"
    exec "nnoremap <silent> <buffer> s <C-W><CR><C-W>K"
    exec "nnoremap <silent> <buffer> S <C-W><CR><C-W>K<C-W>b"
    exec "nnoremap <silent> <buffer> v <C-W><CR><C-W>H<C-W>b<C-W>J<C-W>t"
    exec "nnoremap <silent> <buffer> gv <C-W><CR><C-W>H<C-W>b<C-W>J"
    echom "ag.vim keys: q=quit <cr>/<C-t>/s/v=enter/tab/split/vsplit p/T/S/gv=preview versions of same"
  endif
endfunction
